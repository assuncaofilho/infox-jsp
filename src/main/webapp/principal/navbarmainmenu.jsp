                          ...
                          <div class="">
                              <div class="main-menu-header">
                                  ...
                                  <div class="user-details">
                                      <span id="more-details"><%= session.getAttribute("usuariologin") %><i class="fa fa-caret-down"></i></span>
                                  </div>
                              </div>
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                              <li class="active">
                                  <a href="<%= request.getContextPath()%>/principal/principal.jsp" class="waves-effect waves-dark">
                                      ...
                                      <span class="pcoded-mtext" data-i18n="nav.dash.main">InfoX System</span>
                              ...
                              <li class="pcoded-hasmenu">
                                  <a href="javascript:void(0)" class="waves-effect waves-dark">
                                      ...
                                      <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Servicos</span>
                                      <span class="pcoded-mcaret"></span>
                                  </a>
                                  <ul class="pcoded-submenu">
                                      ...
                                      <li class=" ">
                                          <a href="<%= request.getContextPath()%>/ServletClienteController?acao=listarClientes" class="waves-effect waves-dark">
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Cliente</span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li>
                                      <li class=" ">
